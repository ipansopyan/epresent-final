       ...
       <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                <li class="page-item" v-bind:class="[{disabled : !pagination.prev_page_url}]" >
                    <a class="page-link" href="javascript:void(0)" @click="getmhs(pagination.prev_page_url)" >Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="javascript:void(0)">
                        {{pagination.current_page}} of {{pagination.last_page}}
                    </a></li>
                <li class="page-item " v-bind:class="[{disabled : !pagination.next_page_url}]" >
                    <a class="page-link" href="javascript:void(0)" @click="getmhs(pagination.next_page_url)">Next</a>
                </li>
            </ul>
        </nav>
      </div>
...
<script>
    ...
    methods: {
     getmhs(page_url){
         let url = page_url || 'http://192.168.43.184:8000/api/mhs'
            this.$http({
                url     : url,
                method  : 'GET',
                headers : {
